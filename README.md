...
<!-- PROJET OS -->
## `> cat ~/projects/main.txt`

```
[*] PROJECT : Custom OS (inspired by Terry Davis / TempleOS)
[*] STATUS  : In progress...
[*] STACK   : Assembly · C · Low-level wizardry
[*] GOAL    : Build something from scratch. Real metal. No abstraction.

"I'm programming God's programming language." — Terry Davis
```
